function output_feat = VerticalFeat(I)
% VERTICALFEAT Extracts the features through vertical splitting of the
% skeletonized image.

% B = VerticalFeat(A) extracts the vertical features from the input
% skeletonized image.
try
% clear;
% clc;
% I =  imread('Database/Skel_img/Q-007_recto_lic_s_skel.png');
[m n ] = size(I);
...
I1 = I(1:floor(Geo2(2)),1:floor(Geo1(1)));
...
I2 = I(1:floor(Geo3(2)),floor(Geo1(1)):end);
...
I3 = I(floor(Geo2(2)):end,1:floor(Geo1(1)));
...
I4 = I(floor(Geo3(2)):end,floor(Geo1(1)):end);
