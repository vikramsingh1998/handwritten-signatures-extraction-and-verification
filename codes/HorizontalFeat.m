function output_feat = HorizontalFeat(I)
% HORIZONTALFEAT Extracts the features through horizontal splitting of the
% skeletonized image.

% B = HorizontalFeat(A) extracts the horizontal features from the input
% skeletonized image.
try
% clear;
% clc;
...
I15 = I(floor(Geo10(2)):m,1:floor(Geo11(1)));
Geo26 = GeoCentre(I15);
